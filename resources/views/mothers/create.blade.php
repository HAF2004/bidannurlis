            ...
            <form action="{{ route('mothers.store') }}" method="POST">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="text" name="rt" class="form-control" value="{{ old('rt') }}" placeholder="01">
                    </div>
                    <div class="col-md-2">
                        <label class="form-label">RW</label>
                        <input type="text" name="rw" class="form-control" value="{{ old('rw') }}" placeholder="02">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Provinsi</label>
                        <input type="text" name="provinsi" id="provinsiMother" list="list_provinsi_mother" class="form-control" value="{{ old('provinsi') }}" placeholder="Ketik / pilih provinsi..." autocomplete="off">
                        <datalist id="list_provinsi_mother"></datalist>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Kabupaten / Kota</label>
                        <input type="text" name="kabupaten" id="kabupatenMother" list="list_kabupaten_mother" class="form-control" value="{{ old('kabupaten') }}" placeholder="Ketik / pilih kab/kota..." autocomplete="off">
                        <datalist id="list_kabupaten_mother"></datalist>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Kecamatan</label>
                        <input type="text" name="kecamatan" id="kecamatanMother" list="list_kecamatan_mother" class="form-control" value="{{ old('kecamatan') }}" placeholder="Ketik / pilih kecamatan..." autocomplete="off">
                        <datalist id="list_kecamatan_mother"></datalist>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Desa / Kelurahan</label>
                        <input type="text" name="desa_kelurahan" id="desaMother" list="list_desa_mother" class="form-control" value="{{ old('desa_kelurahan') }}" placeholder="Ketik / pilih desa/kel..." autocomplete="off">
