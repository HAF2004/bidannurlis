                ...
                <form action="{{ route('anc.store', $mother) }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3"><label class="form-label">BB (kg)</label><input type="number" name="bb_kg"
                            ...
                            <div class="col-md-3"><label class="form-label">DJJ</label><input type="number" name="djj"
                                    class="form-control"></div>
                            <div class="col-md-3"><label class="form-label">Hb (g/dL)</label><input type="number" name="hb"
                                    class="form-control" step="0.1"></div>
                            <div class="col-md-3"><label class="form-label">TBJ (gram)</label><input type="number"
                                    name="tbj_gram" class="form-control"></div>
                            <div class="col-12"><label class="form-label">Keterangan</label><textarea name="keterangan"
